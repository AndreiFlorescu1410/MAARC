...
library(readxl)
#ARIMA(17,2,32)
data1 <- import("/Users/andre/OneDrive/Desktop/Facultate/LICENTA/Cod Algoritm/datenoi/p20pro.csv")
...
fit2 <- arima(count_ma, order=c(20,1,30))
...
fcast
fit2 <- arima(count_ma, order=c(17,2,32))
tsdisplay(residuals(fit2), lag.max = 45)
fcast <- forecast(fit2,h=365)
plot(fcast)
